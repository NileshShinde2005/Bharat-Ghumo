...
<head>
    <meta charset="UTF-8">
    <title>Bharat Ghumo - User Sign Up</title>
...
<div class="login-container">
    ...
    <p>Sign up to begin your travel journey</p>
    ...
    %>
    <div class="error-message" style="color:green;">Account created! Please login.</div>
    <% 
    } 
    %>
